...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Subtask firstSubtask = new Subtask("Subtask", "SubtaskDescription", LocalDateTime.of(2022,
                11, 11, 22, 0), 10, epic);
        Subtask secondSubtask = new Subtask("Subtask", "SubtaskDescription", LocalDateTime.of(2022,
                11, 11, 11, 00), 5, epic);
        Subtask thirdSubtask = new Subtask("Subtask", "SubtaskDescription", epic);

        manager.createTask(task);
        manager.createEpic(epic);

        System.out.println("Epic startTime: " + epic.getStartTime() + ", Epic endTime: " + epic.getEndTime());
        ...
        manager.deleteSubtask(firstSubtask.getId());
